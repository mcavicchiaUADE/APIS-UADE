...
CREATE INDEX IF NOT EXISTS idx_detalle_pedido_vendedor ON detalle_pedidos(vendedor_id);
CREATE INDEX IF NOT EXISTS idx_detalle_pedido_estado_item ON detalle_pedidos(estado_item);
CREATE INDEX IF NOT EXISTS idx_detalle_pedido_vendedor_estado ON detalle_pedidos(vendedor_id, estado_item);
...
SELECT '📊 Resumen:' AS tipo, 
       CONCAT('👥 ', (SELECT COUNT(*) FROM usuarios), ' usuarios') AS usuarios,
...
UNION ALL
SELECT '• Vendedor: user1 / password'
UNION ALL
SELECT '• Usuario: testuser / password';
